...
function phone_header () {
	$nav_html = '<ul class="nav_wrap">';
	$nav_html .= '<li><a class="nav_item">首页</a></li>';
	$nav_html .= '<li><a class="nav_item">服务</a></li>';
	$nav_html .= '<li><a class="nav_item phone_image"><img src='.avia_get_option('logo').'></a></li>';
	$nav_html .= '<li><a class="nav_item">案例</a></li>';
	$nav_html .= '<li><a class="nav_item">联系</a></li>';
	$nav_html .= '</ul>';			
	return $nav_html;
}

add_shortcode('phone_header', "phone_header" );

function content_slider_shortcode(){
	$our_product = get_field('our_product',18);
	$content_slider_code = "[av_content_slider heading='' columns='2' animation='slide' navigation='dots' autoplay='false' interval='5' font_color='' color='']";
	foreach($our_product  as $our_product_item){
		$content_slider_code .= "[av_content_slide tags='' link='' linktarget='']";
		$content_slider_code .= "<div class='silder_wrap'>";
		$content_slider_code .= "<div class='left_image'>";
		$content_slider_code .=  "<img src=".$our_product_item['product_icon']." >";
		$content_slider_code .= "</div>";
		$content_slider_code .= "<div class='right_content'>";
		$content_slider_code .=  $our_product_item['product_describe'];
		$content_slider_code .= "</div>";
		$content_slider_code .= "</div>";
		$content_slider_code .= "[/av_content_slide]";
	}
	$content_slider_code .= "[/av_content_slider]";
	return do_shortcode($content_slider_code);
}

add_shortcode('content_slider_shortcode', "content_slider_shortcode" );

function our_service_shortcode(){
	$our_service_code = '<div class="phone_service_wrap">';
	$our_service_code .= '<div class="phone_service_item">';
	$our_service_code .= '<div class="phone_service_title">askdasdk</div>';
	$our_service_code .= '<div class="phone_service_content">asdasldlasdskl</div>';
	$our_service_code .= '</div>';
	$our_service_code .= '</div>';
	return $our_service_code;
}

add_shortcode('our_service_shortcode', 'our_service_shortcode');
/*
