...
if ( !class_exists( 'avia_slideshow' ) )
{
	class avia_slideshow
	{
		...
		protected function slide_navigation_arrows()
		{
			...
			$html .= 	"<a href='#prev' class='prev-slide' ".av_icon_string('prev_big')."><div class='stand_text'>+&nbsp;&nbsp;&nbsp;&nbsp;365 NEXUS CLOUD&nbsp;&nbsp;&nbsp;&nbsp;+</div></a>";
			$html .= 	"<a href='#next' class='next-slide' ".av_icon_string('next_big')."><div class='stand_text'>+&nbsp;&nbsp;&nbsp;&nbsp;CLOUD NEXUS 365&nbsp;&nbsp;&nbsp;&nbsp;+</div></a>";
			$html .= "</div>";
		...
		protected function slide_navigation_dots()
		{
			...
			$mouse_upload_dir = wp_upload_dir();

			$html .= "<div class='mouse_wrap'><img src='".$mouse_upload_dir['baseurl']."/2019/07/shubiao.png'></div>";
			$html .= "</div>";
